...
def train():
    ...
    tb_log = f"./tasks/climb/tensorboard/{run_id}/"
    ...
    os.makedirs('./tasks/climb/models_checkpoints', exist_ok=True)
    checkpoint_callback = CheckpointCallback(
        save_freq=real_save_freq,
        save_path='./tasks/climb/models_checkpoints',
    ...
    model.save("tasks/climb/ppo_climb_final")
    run.finish()
